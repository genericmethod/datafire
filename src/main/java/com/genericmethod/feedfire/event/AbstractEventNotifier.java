...
public abstract class AbstractEventNotifier<T extends CacheableObject> {
    ...
    /***
     * Compare the objects that have been returned from the feed to the objects that are currently in cache.
     * Update cache and generate the required events.
     *
