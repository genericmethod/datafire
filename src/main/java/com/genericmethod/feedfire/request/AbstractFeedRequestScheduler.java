...
/**
 * This abstract class handles the scheduled task of
 * downloading and mapping an XML feed to objects of type T,
 * converting them to objects of Type O and putting them in the designated cache.
 * <p/>
...
public abstract class AbstractFeedRequestScheduler<T extends CacheableObject> {
    ...
    /**
     * Return the XmlFeedMapper instance that maps the is used to map the xml string to generic objects
     *
